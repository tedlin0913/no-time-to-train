...
python no_time_to_train/dataset/sam_bbox_to_segm_batch.py \
    --input_json ../data/nttt/plant2/annotations/custom_references.json \
    --image_dir ../data/nttt/plant2/images \
    --sam_checkpoint checkpoints/sam_vit_h_4b8939.pth \
    --model_type vit_h \
    --device cuda \
    --batch_size 8 \
...
python no_time_to_train/dataset/coco_to_pkl.py \
    ../data/nttt/plant2/annotations/custom_references_with_segm.json \
    ../data/nttt/plant2/annotations/custom_references_with_segm.pkl \
    1
